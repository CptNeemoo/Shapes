...
public class Main {
    ...
    private static void calculateSumOfDigits() {
        ...
        log.info(String.format("The sum of number %d with modulo function is %d",
                number1, DigitSumExecutor.DigitsSumModulo(number1)));
        log.info(String.format("The sum of number %d with char function is %d",
                number1, DigitSumExecutor.DigitsSumChar(number1)));
        log.info(String.format("The sum of number %d with modulo function is %d",
                number2, DigitSumExecutor.DigitsSumModulo(number2)));
        log.info(String.format("The sum of number %d with char function is %d",
                number2, DigitSumExecutor.DigitsSumChar(number2)));
    }
